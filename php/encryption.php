...
trait encryption
{
    ...
    public static function encryptText(string $plaintext, string $Key = null): string
    {
    ...
    public static function decryptText(string $encryptedText, string $Key = null): string
    {
        $encryptionKey = $Key ?? self::$encryptionKey;
